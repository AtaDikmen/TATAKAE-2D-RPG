...
public class CharacterStats : MonoBehaviour
{
    ...
    public Stat intelligence; // 1 point increase magic damage by 1 and magic resistance b 3
    ...
    public virtual void DoMagicalDamage(CharacterStats _targetStats)
    {
        ...
        AttempToApplyAilements(_targetStats, _fireDamage, _iceDamage, _lightingDamage);
    }

    private void AttempToApplyAilements(CharacterStats _targetStats, int _fireDamage, int _iceDamage, int _lightingDamage)
    {
        ...
        while (!canApplyIgnite && !canApplyChill && !canApplyShock)
        {
            ...
            if (Random.value < .4f && _lightingDamage > 0)
            {
                canApplyShock = true;
                _targetStats.ApllyAilments(canApplyIgnite, canApplyChill, canApplyShock);
                return;
    ...
    public virtual void IncreaseHealthBy(int _amount)
    {
        ...
        if(currentHealth > GetMaxHealthValute())
            currentHealth = GetMaxHealthValute();
